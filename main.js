...
(function () {
    ...
    if (location.pathname == "/user" || (location.pathname.startsWith("/user/" + username) && username)) {
        if (!username) {
            username = document.querySelector(".header-personal-right").querySelector(".header-info-title").textContent;
        ...
        comikNet_panel_info.innerHTML = "<p>你好, " + username + ", 欢迎使用 Friendship ComikNet 服务!</p>";
